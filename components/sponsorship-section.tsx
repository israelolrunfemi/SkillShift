...
subtitle: "⭐ (Exclusive – 1 Sponsor Only)",
price: "₦5,000,000+",
...
featured: true,
exclusive: "⭐ (Exclusive – 1 Sponsor Only)",
benefits: [
"Event naming rights: “Tech Expo 2025 powered by [Brand]",
"Full industry exclusivity (only one sponsor per sector)",
"Premium branding across all touchpoints (stage, banners, backdrops, website, social media, souvenirs, press kits)",
"On-campus marketing campaign (1-week takeover across UNILAG reaching 2,000+ students)",
"Prime product activation zone or branded lounge",
"Exclusive VIP dinner with speakers, government officials & industry leaders",
"First choice panel seat + breakout session hosting rights",
"Media amplification (TV, radio, digital press, influencer highlights)",
"Honorary award presentation on stage + certificate of recognition",
"Personalized shoutouts from the MC throughout the event",
"Priority networking access (Speakers’ Green Room + VIP areas)",
],
},

{
name: "Gold Premium",
subtitle: "Designed for brands seeking strong prestige without full naming rights.",
price: "₦3,000,000+",
...
benefits: [
"Prominent branding across venue and media platforms",
"Panel participation or opportunity to co-host a breakout session",
"Premium product exhibition booth with high-traffic placement",
"Mass campus promotion (branded flyers, banners, or giveaways)",
"Media features (press kits, digital/social mentions)",
"Branding on selected event souvenirs",
"MC mentions during key sessions",
"5 VIP passes + access to the Speakers’ Green Room",
"Recognition award presented on stage",
],
},
{
name: "GOLD SPONSOR ",
subtitle: "Balanced package for visibility and engagement.",
price: "₦2,000,000+",
...
exclusive: "Gold +",
benefits: [
"	High-visibility branding during sessions & workshops",
"Standard exhibition booth for product showcasing",
"Digital exposure: mentions across official student channels & event platforms",
"Media mentions (press releases, social posts)",
"3 VIP passes for networking opportunities",
"Branding on selected materials",
"MC shoutouts during sessions",
],
},
{
name: "SILVER SPONSOR",
subtitle: "Accessible package for SMEs & rising brands.",
price: "₦1,000,000+",
...
benefits: [
"Branding across digital platforms and select venue points.",
"Inclusion in the official program and event press pack",
"Right to include branded items in attendee gift kits",
"Product showcase space (shared booth option)",
"2 VIP seats for plenary access",
"MC recognition during event highlights",

],
},
{
name: "BRONZE SPONSOR",
subtitle: "Entry-level sponsorship for visibility.",
price: "₦500,000+",
...
benefits: [
"Logo placement on event slides and select banners",
"Recognition during opening & closing sessions",
"2 VIP passes for event access",
"Right to distribute branded souvenirs",
"Mention in thank-you social media post"
],
},
{
name: "SUPPORTER TIER",
subtitle: "Perfect for startups, alumni, and small businesses.",
price: " ₦100,000 – ₦499,000",
icon: <Heart className="w-7 h-7 sm:w-10 sm:h-10 lg:w-14 lg:h-14" />,
color: "#71717A",
secondaryColor: "#A1A1AA",
bgColor: "bg-zinc-500/5",
borderColor: "border-zinc-500/20",
featured: false,
exclusive: "SME CIRCLE",
benefits: [
"Logo on select digital & print materials.",
"Social media recognition as an official supporter",
"1 VIP pass for event access.",
"Grouped recognition in the supporters’ appreciation slide",
...
All sponsorship packages can be tailored to meet specific industry needs. We are open to co-creating custom benefits that align with your brand’s unique objectives, whether it’s recruitment, product activation, 
thought leadership, or market visibility.
